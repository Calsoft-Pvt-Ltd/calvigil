...
| `internal/matcher/`         | [matcher.go](../internal/matcher/matcher.go), [canonical.go](../internal/matcher/canonical.go), [osv.go](../internal/matcher/osv.go), [ossindex.go](../internal/matcher/ossindex.go), [nvd.go](../internal/matcher/nvd.go), [ghsa.go](../internal/matcher/ghsa.go), [kev.go](../internal/matcher/kev.go) | Packages → vulnerabilities (OSV / OSS Index / NVD / GHSA), canonical normalize+merge, CISA KEV enrichment, with caching | 8 | 6 |
