...
import (
	...
	"github.com/Calsoft-Pvt-Ltd/calvigil/internal/scanner"
...
func init() {
	...
	scanCmd.Flags().StringVar(&scanOpts.SemgrepRules, "semgrep-rules", "", "path to custom Semgrep rule YAML file or directory")
